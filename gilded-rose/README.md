...
2. Run the tests with the coverage (will generate the code coverage)
    ```
    coverage run -m unittest test.test_gilded_rose.GildedRoseTest
    ```
...
1. Tennis 1, 2 & 3 should be replaced by many small exercices outlining one problem each
2. They should serve as slides for theory
3. We should introduce the concept of unit testing on small exercices dedicated to this
4. To ensure no one just deletes and rewrites the code from scratch, maybe remove some details in the requirements.txt