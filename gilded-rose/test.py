...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_sellin(self):
        gilded_rose = GildedRose(test_cases_sellin["it"])
        gilded_rose.update_quality()
        
        for i, expected in enumerate(test_cases_sellin["expect"]):
            self.assertEquals(expected, gilded_rose.items[i].sell_in)
